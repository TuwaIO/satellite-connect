 ...
 */
function getConnectorName(connectors: any[] | undefined, activeConnector: string | undefined): string | undefined {
...
export function ConnectModal({
  ...
  store,
  withImpersonated,
}: InitialChains & Pick<ConnectButtonProps, 'store' | 'withImpersonated'>) {
  const {
    isConnectModalOpen,
  ...
  const getTitle = () => {
    switch (connectModalContentType) {
      ...
      case 'connecting':
        if (selectedAdapter && activeConnector) {
