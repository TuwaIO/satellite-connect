  ...
  return (
    <nav role="navigation" aria-label={labels.walletControls}>
      <div className="flex items-center gap-2 sm:gap-3">
        ...
        {withChain && isConnected && <ChainSelector appChains={appChains} solanaRPCUrls={solanaRPCUrls} />}
        ...
        >
          <button
            ...
            tabIndex={0}
          >
            {isConnected ? <ConnectedContent transactionPool={transactionPool} /> : <WaitForConnectionContent />}
          </button>
        </motion.div>
